#include "GFX/Pipeline/BuildResult.h"

namespace ZE::GFX::Pipeline
{
	std::string BuildResult::message(int condition) const
	{
#define DECODE(res, msg) case BuildResultCode::##res: return (msg)
		switch (static_cast<BuildResultCode>(condition))
		{
		default:
			ZE_ENUM_UNHANDLED();
		DECODE(ErrorUnknown, "Unknown Error");
