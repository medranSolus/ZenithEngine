#if FFX_FSR2_OPTION_APPLY_SHARPENING && FFX_FSR2_OPTION_REPROJECT_USE_LANCZOS_TYPE == 1
#	define ZE_FSR2_CB_RANGE 14
#elif FFX_FSR2_OPTION_APPLY_SHARPENING || FFX_FSR2_OPTION_REPROJECT_USE_LANCZOS_TYPE == 1
