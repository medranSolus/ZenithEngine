...
TEXTURE_EX(motionVectors, Texture2D<MotionGB>, 2, 6); // External resource format
TEXTURE_EX(reactiveMask, Texture2D<ReactiveGB>, 3, 7); // External resource format
TEXTURE_EX(transparencyCompositionMask, Texture2D<TransparencyGB>, 4, 8); // External resource format
