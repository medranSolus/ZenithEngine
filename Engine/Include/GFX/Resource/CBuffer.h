...
namespace ZE::GFX::Resource
{
	...
	public:
		...
		constexpr void Update(Device& dev, IO::DiskManager& disk, const CBufferData& data) const { ZE_ASSERT(data.Data && data.Bytes, "Empty buffer!"); ZE_RHI_BACKEND_CALL(Update, dev, disk, data); }
