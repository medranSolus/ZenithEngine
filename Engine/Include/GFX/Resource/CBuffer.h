...
namespace ZE::GFX::Resource
{
	...
	public:
		...
		constexpr void Init(Device& dev, IO::DiskManager& disk, const CBufferData& data) { ZE_ASSERT((data.DataStatic || data.DataRef) && data.Bytes, "Empty buffer!"); ZE_RHI_BACKEND_VAR.Init(dev, disk, data); }
		...
		constexpr void Update(Device& dev, IO::DiskManager& disk, const CBufferData& data) const { ZE_ASSERT((data.DataStatic || data.DataRef) && data.Bytes, "Empty buffer!"); ZE_RHI_BACKEND_CALL(Update, dev, disk, data); }
