...
#define ZE_FFX_ERROR(code) ZE::GFX::External::Error::Ffx::Make(code)
...
#define ZE_NGX_ERROR(code) ZE::GFX::External::Error::NGX::Make(code)
...
#define ZE_XESS_ERROR(code) ZE::GFX::External::Error::XeSS::Make(code)
