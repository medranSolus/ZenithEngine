...
namespace ZE::GFX::Pipeline
{
	...
	class RenderNode final
	{
		...
		PassExecutionType execType = PassExecutionType::Producer;
	...
	public:
		...
		void AddInput(std::string&& name, TextureLayout layout, bool required = true) noexcept;
		...
		void AddOutput(std::string&& name, TextureLayout layout, std::string_view resourceName, std::string_view replacement = "") noexcept;
	};
}