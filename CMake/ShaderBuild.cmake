...
function(_prepare_shader_compile_for_api API SD_TYPE SD_TYPE_DIR SD_TYPE_SRC_LIST SD_TYPE_INC_LIST SD_CUSTOM_FLAGS)
    if(${API} STREQUAL "DX11")
        ...
        set(API_FLAGS "/D_ZE_COMPILER_FXC /DZE_HLSL_6_6=0")
        set(SD_EXT "dxbc")
    elseif(${API} STREQUAL "DX12")
        string(TOLOWER "${SD_TYPE}_6_6" ${SD_TYPE}_TYPE_FLAG)
        set(SD_COMPILER "${EXTERNAL_DIR}/dxc.exe")
        set(API_FLAGS "/D_ZE_COMPILER_DXC -enable-16bit-types /DFFX_HLSL_6_2=1 /DNIS_DXC=1 /DNIS_HLSL_6_2=1 /DZE_HLSL_6_6=1")
    ...
    elseif(${API} STREQUAL "VK")
        ...
        set(SD_COMPILER "${EXTERNAL_DIR}/dxc.exe")
        set(API_FLAGS "/D_ZE_COMPILER_DXC /DNIS_DXC=1 /DZE_HLSL_6_6=0 -spirv -fvk-stage-io-order=decl -fvk-use-dx-layout -fvk-use-dx-position-w -fspv-target-env=vulkan1.3 -fspv-flatten-resource-arrays")
