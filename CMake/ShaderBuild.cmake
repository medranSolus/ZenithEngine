...
function(_prepare_shader_compile_for_api API SD_TYPE SD_TYPE_DIR SD_TYPE_SRC_LIST SD_TYPE_INC_LIST SD_CUSTOM_FLAGS)
    ...
    elseif(${API} STREQUAL "DX12")
        ...
        set(API_FLAGS "/D_ZE_COMPILER_DXC -enable-16bit-types /DNIS_HLSL=1 /DNIS_DXC=1 /DZE_HLSL_6_VER=6")
    ...
    elseif(${API} STREQUAL "VK")
        ...
        set(SD_COMPILER "${EXTERNAL_DIR}/dxc.exe")
        set(API_FLAGS "/D_ZE_COMPILER_DXC /DNIS_HLSL=1 /DNIS_DXC=1 /DZE_HLSL_6_VER=0 -spirv -fvk-stage-io-order=decl -fvk-use-dx-layout -fvk-use-dx-position-w -fspv-target-env=vulkan1.3 -fspv-flatten-resource-arrays")
