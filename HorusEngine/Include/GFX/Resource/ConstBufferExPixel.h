...
namespace GFX::Resource
{
	...
	public:
		ConstBufferExPixel(Graphics& gfx, const std::string& tag, const Data::CBuffer::DCBLayoutElement& root,
		...
		static GfxResPtr<ConstBufferExPixel> Get(Graphics& gfx, const std::string& tag, const Data::CBuffer::DCBLayoutElement& root,
