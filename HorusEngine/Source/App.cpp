		...
		Camera::CameraParams({ -8.0f, 0.0f, 0.0f }, "Main camera", Math::ToRadians(90.0f), 0.0f, 1.047f, 0.01f, 500.0f)))
{
	...
	//params = { Float3(-20.0f, 0.0f, -6.0f), Float3(Math::ToRadians(35.0f), Math::ToRadians(270.0f), Math::ToRadians(110.0f)), "Sting Sword", 0.2f };
	//AddShape({ window.Gfx(), renderer, "Models/Sting_Sword/Sting_Sword.obj", params });
	//params = { Float3(41.6f, 18.5f, 8.5f), Float3(0.0f, Math::ToRadians(87.1f), Math::ToRadians(301.0f)), "TIE", 3.6f };
