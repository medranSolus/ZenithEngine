...
namespace WinAPI
{
	Window::WindowClass::WindowClass() noexcept : hInstance(GetModuleHandle(nullptr))
	{
		...
		wndClass.hIcon = static_cast<HICON>(LoadImage(hInstance, ICON_PATH, IMAGE_ICON, 128, 128, LR_LOADFROMFILE));
		wndClass.hIconSm = static_cast<HICON>(LoadImage(hInstance, ICON_PATH, IMAGE_ICON, 32, 32, LR_LOADFROMFILE));
