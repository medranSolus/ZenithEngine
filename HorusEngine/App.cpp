...
App::App() : window(width, height, windowTitle)
{
	...
	pointLight = std::make_shared<GFX::Light::PointLight>(window.Gfx(), DirectX::XMFLOAT3(0.0f, 8.0f, 10.0f), "PointLight");
	...
	AddShape(std::make_shared<GFX::Shape::Model>(window.Gfx(), "Models/brick_wall/brick_wall.obj", DirectX::XMFLOAT3(0.0f, 0.0f, 5.0f), "Wall"));
