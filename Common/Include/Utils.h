...
#pragma region Functions
	...
	static constexpr U32 CRC32LookupTable[256]
	{
	...
	static constexpr U64 CRC64LookupTable[256]
	{
	...
	constexpr U32 CalculateCRC32(const char str[], U64 size) noexcept
	{
		...
		for (U64 i = 0; i < size; ++i)
			crc = (crc >> 8) ^ CRC32LookupTable[(crc ^ str[i]) & 0xFF];
	...
	constexpr U64 CalculateCRC64(const char str[], U64 size) noexcept
	{
		...
		for (U64 i = 0; i < size; ++i)
			crc = (crc << 8) ^ CRC64LookupTable[((crc >> 56) ^ str[i]) & 0xFF];
